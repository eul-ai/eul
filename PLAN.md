...
- Standard-library-only Go; Bash is required at runtime.
...
project indexing, LSP integration, multimodal input, and session persistence.
...
tool/            read, write, edit, bash, registry, and output limits
