...
background and uses effort-colored input rules. Reasoning summaries use muted
italic text, while compact tool blocks use padded pending, success, and error
backgrounds. The
current palette is based on the
